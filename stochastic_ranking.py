...
"""
'''
Constrained genetic algorithm by stochastic ranking
...
The optimum obtained by the code is (2.247015, 2.386587; 13.60247) (One of the optimum, the values are almost the same)
...
class GA(object):
    ...
    Constructor
    '''
    def __init__(self, m, t, pc, pm,varnum,chromlength,violationnum):  # initialize
    ...
    '''
    @staticmethod
    def bubblesort(arr, popviolation):
        tmparr = []
        tmppopviolation = []
        ...
        for i in range(0, arrLen):
            ...
            for j in range(0, arrLen - 1):
                ...
                if (tmppopviolation[j] == 0 and tmppopviolation[j + 1] == 0) or randfloat < 0.45:
                    ...
                    if tmppopviolation[j] < tmppopviolation[j + 1]:
                        temp = tmparr[j]
                        tmparr[j] = tmparr[j + 1]
                        tmparr[j + 1] = temp
                        tempindex = index[j]
    ...
    def showres(self, pop):
        ...
        index = GA.bubblesort(popfitness, popviolation)
    ...
    def select_new(self, pop):
        ...
        index = GA.bubblesort(popfitness, popviolation)         #stochastic ranking
...
if (__name__ == '__main__'):
    ...
    GAobj = GA(m=300, t=150, pc=0.8, pm=0.08,varnum=2,chromlength=20,violationnum=2)
